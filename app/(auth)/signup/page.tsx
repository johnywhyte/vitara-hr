    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#FCF5EB]">
        <div className="w-full max-w-sm bg-white rounded-lg border border-[#DEE2E6] shadow-sm p-6 text-center">
          ...
          <h2 className="text-base font-bold text-[#343A40] mb-2">Check Your Email</h2>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10 bg-[#FCF5EB]">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-lg font-bold text-[#343A40]">Create Account</h1>
          <p className="text-xs text-[#6C757D] mt-0.5">Start your application today</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-[#DEE2E6] shadow-sm p-5">
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <span className="text-[10px] text-[#ADB5BD] font-semibold uppercase">or</span>
            <div className="h-px flex-1 bg-[#E9ECEF]" />
          </div>
