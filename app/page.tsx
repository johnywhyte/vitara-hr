...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-[#FCF5EB]">
      <div className="w-full max-w-sm">
        <div className="bg-[#71001D] rounded-xl p-6 mb-5 text-center shadow-md">
        ...
        <div className="bg-white rounded-lg border border-[#DEE2E6] shadow-sm p-4 mb-4">
          ...
          {[
            ...
            <div key={item.step} className="flex items-start gap-3 mb-3 last:mb-0">
              <div className="w-6 h-6 rounded-full bg-[#FFF3CD] border border-[#FFE59E] flex items-center justify-center shrink-0">
                <span className="text-[10px] font-bold text-[#71001D]">{item.step}</span>
              </div>
              <div>
        ...
        <div className="flex flex-col gap-2.5">
          <Link
            href="/signup"
            className="w-full bg-[#71001D] text-white text-sm font-semibold py-2.5 rounded-md text-center hover:bg-[#5A0017] transition-colors"
          >
            Start Application
          </Link>
          <Link
            href="/login"
            className="w-full bg-white text-[#71001D] text-sm font-semibold py-2.5 rounded-md text-center border border-[#71001D] hover:bg-[#FFF3CD] transition-colors"
          >
